...
bool PluginCore::processAudioFrame(ProcessFrameInfo& processFrameInfo)
{
	...
	// --- read input (adapt to your framework)
	double xnL = processFrameInfo.audioInputFrame[0]; //< input sample L 
	double xnR = processFrameInfo.audioInputFrame[1]; //< input sample R
       ...
       processFrameInfo.channelIOConfig.outputChannelFormat == kCFStereo)
    {
		// --- pass through code: change this with your signal processing
		processFrameInfo.audioOutputFrame[0] = ynL; //< output sample L 
		processFrameInfo.audioOutputFrame[1] = ynR; //< output sample R
...
bool PluginCore::initPluginParameters()
{
	...
	piParam = new PluginParameter(controlID::filterType, "Filter Type", "kLPF1P,kLPF1,kHPF1,kLPF2,kHPF2,kBPF2,kBSF2,kButterLPF2,kButterHPF2,kButterBPF2,kButterBSF2,kMMALPF2,kMMALPF2B,kLowShelf,kHiShelf,kNCQParaEQ,kCQParaEQ,kLWRLPF2,kLWRHPF2,kAPF1,kAPF2,kResonA,kResonB,kMatchLP2A,kMatchLP2B,kMatchBP2A,kMatchBP2B,kImpInvLP1,kImpInvLP2", "kLPF1P");
	...
	piParam = new PluginParameter(controlID::boostCut_db, "Boost/Cut", "", controlVariableType::kDouble, -20.000000, 20.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(false);
	piParam->setSmoothingTimeMsec(100.00);
