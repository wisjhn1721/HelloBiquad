...
public:
	...
	// --- coefficient array index values
...
private:
	...
	int filterType = 0;
	enum class filterTypeEnum { kLPF1P,kLPF1,kHPF1,kLPF2,kHPF2,kBPF2,kBSF2,kButterLPF2,kButterHPF2,kButterBPF2,kButterBSF2,kMMALPF2,kMMALPF2B,kLowShelf,kHiShelf,kNCQParaEQ,kCQParaEQ,kLWRLPF2,kLWRHPF2,kAPF1,kAPF2,kResonA,kResonB,kMatchLP2A,kMatchLP2B,kMatchBP2A,kMatchBP2B,kImpInvLP1,kImpInvLP2 };	// to compare: if(compareEnumToInt(filterTypeEnum::kLPF1P, filterType)) etc... 
